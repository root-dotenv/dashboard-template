      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            {...register("username")}
            className={cn(
              "pl-10 dark:bg-gray-700 dark:border-gray-600",
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            {...register("password")}
            className={cn(
              "pl-10 pr-10 dark:bg-gray-700 dark:border-gray-600",
  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-[#F1F7FD] dark:bg-gray-900 p-4">
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="w-full max-w-4xl bg-white dark:bg-gray-800 shadow-2xs rounded-xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
          <div className="p-8 md:p-12 flex flex-col justify-center">
            <div className="mb-8">
              {/* <img
                ...
                alt="SafariPro Logo"
              /> */}
              <h1 className="text-2xl font-bold text-[#1D2939] dark:text-white">
                Login{" "}
              </h1>
