...
//           </div>
//           <div className="flex items-center gap-2">
//             <RiStackLine className="text-gray-600 dark:text-[#98A2B3]" />
//             <span className="font-medium text-[#1D2939] dark:text-[#D0D5DD]">
//               Floor Number:
//             </span>
//             <span className="text-gray-600 dark:text-[#98A2B3]">
...
//       },
//       enabled: false, // Keep disabled to allow initial manual trigger
//       retry: false,
//     });

//   // ENHANCEMENT: Automatically search for the default 5-day range on mount
//   useEffect(() => {
//     handleSearch();
...
//                 <Check size={16} /> AVB = Available
//               </div>
//               <div className="flex items-center gap-1 text-amber-600">
//                 <Minus size={16} /> BKD = Booked
//               </div>
//               <div className="flex items-center gap-1 text-rose-600">
//                 <X size={16} /> MNC = Maintenance
//               </div>
//             </div>
...
//                     <TableHead className="h-14 px-6 font-semibold text-[13px] uppercase text-[#667085] dark:text-[#98A2B3] bg-gradient-to-b from-slate-50 to-slate-100 dark:from-[#101828] dark:to-[#101828]/90 shadow-sm sticky left-0 z-20 min-w-[200px]">
//                       Room
//                     </TableHead>
//                     {dateHeaders.map((date) => (
//                       <TableHead
//                         key={date.toString()}
//                         className="h-14 px-6 font-semibold text-[13px] uppercase text-[#667085] dark:text-[#98A2B3] bg-gradient-to-b from-slate-50 to-slate-100 dark:from-[#101828] dark:to-[#101828]/90 text-center"
//                       >
//                         {format(date, "MMM dd")}
//                       </TableHead>
//                     ))}
//                     <TableHead className="h-14 px-6 font-semibold text-[13px] uppercase text-[#667085] dark:text-[#98A2B3] bg-gradient-to-b from-slate-50 to-slate-100 dark:from-[#101828] dark:to-[#101828]/90 text-right sticky right-0 z-20 min-w-[200px]">
//                       Actions
//                     </TableHead>
//                   </TableRow>
//                 </TableHeader>
...
//                       <TableRow
//                         key={room.room_id}
//                         className="border-b border-gray-200 dark:border-b-[#1D2939]"
//                       >
//                         <TableCell className="px-6 py-4 sticky left-0 z-10 bg-white dark:bg-[#171F2F]">
...
//                               className="px-6 py-4 text-center font-semibold text-xs"
//                             >
//                               {renderStatusCell(day?.availability_status || "")}
//                             </TableCell>
//                           );
//                         })}
//                         <TableCell className="px-6 py-4 text-right sticky right-0 z-10 bg-white dark:bg-[#171F2F]">
...
//                               className="text-blue-600 no-underline h-auto p-0"
//                             >
//                               View Room
//                             </Button>
//                           </div>
