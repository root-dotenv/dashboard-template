                ...
                <div className="border-t border-gray-200 dark:border-[#1D2939] pt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {room.amenities.map((amenity) => (
                      <span
                        key={amenity.id}
                        className="bg-gradient-to-r from-[#EFF6FF] to-blue-50 text-blue-600 border border-blue-200 rounded-full px-4 py-2 text-sm font-medium hover:from-blue-100 hover:to-indigo-100 transition-all duration-200 cursor-default dark:bg-[#162142] dark:text-[#7592FF] dark:border-[#162142]"
                      >
                        {amenity.name}
                      </span>
                    ))}
